...
## Что было сделано
Добавлено в vagrant - файл установка компиляторов gcc, cpp

Создан bash скрипт, который устанавливает необходимый (измененный) софт при инициализации ВМ, складывает все в папку для локального репозитория и публикует ее. Также изменен конфиг nginx.

Скрипт сборки и установки nginx: [https://github.com/DmitriiKuvshinov/otus-linux/blob/homework-7/repo/nginx/nginx.sh]
